...
io.confluent.kafka.schemaregistry.rules.PiiProto.Pii defaultValue);
  ...
  private static final long serialVersionUID = 0L;
    ...
    @java.lang.Override public io.confluent.kafka.schemaregistry.rules.KindProto.Kind getKind() {
      ...
      return result == null ? io.confluent.kafka.schemaregistry.rules.KindProto.Kind.ZERO : result;
    }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 80: {
                ...
                io.confluent.kafka.schemaregistry.rules.KindProto.Kind tmpValue =
                    io.confluent.kafka.schemaregistry.rules.KindProto.Kind.forNumber(tmpRaw);
                if (tmpValue == null) {
...
io.confluent.kafka.schemaregistry.rules.PiiProto.Pii defaultValue) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "maregistry.rules\032\024confluent/meta.proto\032\t" +
      "Pii.proto\032\nKind.proto\"\234\004\n\007Widget2\022\036\n\004nam" +
      "e\030\001 \002(\tB\020\202D\r\032\003PII\032\006PUBLIC\022\020\n\010lastName\030\002 " +
      "\001(\t\022\020\n\010fullName\030\003 \001(\t\022\017\n\007mybytes\030\004 \001(\014\022\r" +
      ...
      "\001(\010\022;\n\004kind\030\n \001(\0162-.io.confluent.kafka.s" +
      "chemaregistry.rules.Kind\022\036\n\003ssn\030\013 \003(\tB\021\202" +
      "D\016\032\003PII\032\007PRIVATE\022?\n\tpii_array\030\014 \003(\0132,.io" +
      ".confluent.kafka.schemaregistry.rules.Pi" +
      "i\022M\n\007pii_map\030\r \003(\0132<.io.confluent.kafka." +
      "schemaregistry.rules.Widget2.PiiMapEntry" +
